...
HD_PWD='C:/Users/Daniele/Desktop/università/elettronica digitale/progetto III/RAM/RAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Usa_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Usa_RAM.tcl
